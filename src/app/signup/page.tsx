...
export default function SignupPage() {
  ...
  const handleSignup = (e: React.FormEvent) => {
    ...
    // Simulate secure 1.5s registration
    setTimeout(() => {
      // In a mock environment we will simply securely "log them in" instantly
      login(email, name);
      setIsLoading(false);
      router.push("/");
    }, 1500);
  ...
  return (
    <div className="relative min-h-screen bg-[#050505] flex items-center justify-center p-4 overflow-hidden selection:bg-[#FF1744] selection:text-white">
      ...
      <div className="absolute bottom-1/4 left-1/4 w-[500px] h-[500px] bg-[#FF6B9D]/10 rounded-full blur-[100px] pointer-events-none animate-pulse" />
      <div className="absolute top-1/4 right-1/4 w-[400px] h-[400px] bg-[#FF1744]/10 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="relative z-10 w-full max-w-md animate-in fade-in zoom-in duration-700">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-white/40 text-xs uppercase tracking-[0.2em] mt-4">Create Your Account</p>
        </div>
        ...
        <div className="backdrop-blur-2xl bg-white/[0.02] border border-white/10 rounded-[2rem] p-8 sm:p-12 shadow-[0_0_50px_rgba(0,0,0,0.5)]">
          <form onSubmit={handleSignup} className="flex flex-col gap-6 relative">
            ...
            <div className="space-y-2">
              <label className="text-[10px] text-white/50 tracking-[0.2em] uppercase ml-2">Full Name</label>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between ml-2">
                <label className="text-[10px] text-white/50 tracking-[0.2em] uppercase">Create Password</label>
              </div>
              <div className="relative group">
                <input 
                  type="password" 
              ...
              <p className="text-white/20 text-[9px] uppercase tracking-widest ml-2 mt-1">Minimum 6 characters, highly secure.</p>
            </div>
          ...
          <div className="mt-8 text-center border-t border-white/10 pt-6">
            <p className="text-[10px] text-white/40 uppercase tracking-widest">
              ...
              <Link href="/login" className="text-[#FF1744] hover:text-white transition-colors font-bold ml-1">
                Log In
              </Link>
            </p>
          </div>
